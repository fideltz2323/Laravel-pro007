...
class TravellersController extends Controller {
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		$this->data['travelers'] = Travellers::all();
		$this->data['addon'] = AddOn::all();
		$this->data['id'] = $id;
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			...
			$data["addon"] = json_encode($request->input("addon"));
			$data["travelerIDs"] = json_encode($request->input("travelerIDs"));
