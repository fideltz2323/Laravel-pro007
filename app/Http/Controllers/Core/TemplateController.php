...
class TemplateController extends Controller {
	...
	{
		$data = array('pageTitle' =>'ManageMyBookings.net' , 'pageNote'=>'Changelogs' );
		return view('core.template.Changelog',$data);	
	} 
	
	static function getSwift()
	{
		$data = array('pageTitle' =>'ManageMyBookings.net' , 'pageNote'=>'Swift' );
		return view('core.template.Swift',$data);	
	} 
	
	static function getIcons()
	{
		$data = array('pageTitle' =>'ManageMyBookings.net' , 'pageNote'=>'Icons' );
