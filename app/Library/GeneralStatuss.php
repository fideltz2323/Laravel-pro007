...
class GeneralStatuss
{
    ...
    static public function Tour_without_total( $Status , $Start , $End ,$id ,$total )
    {
        ...
        elseif($Status =='1'):
            if($Start > $today):
                if ($available!='0')
                    return '<span class="tips text-yellow" title="'.Lang::get('core.upcomingtour').'"><i class="fa fa-random fa-2x" aria-hidden="true"></i>  </span>';
                else
                {return '<span class="text-red tips" title="Upcoming Tour"><i class="fa fa-random fa-2x" aria-hidden="true"></i>  </span>';}
            elseif($End < $today):
                return '<span class="text-blue tips" title="'.Lang::get('core.pasttours').'"> <i class="fa fa-calendar-check-o fa-2x" aria-hidden="true"></i>
  </span>';
            elseif($Start <= $today and $End >= $today):
