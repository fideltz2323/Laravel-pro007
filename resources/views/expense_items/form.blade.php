...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'expenseitems/save/'.\App\Library\SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'expensesFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> {{ Lang::get('core.expenseitems') }}</legend>
				{!! Form::hidden('id', $row['id']) !!}
									  <div class="form-group  " >
										<label for="Extra Expenses" class=" control-label col-md-4 text-left"> {{ Lang::get('core.name') }} <span class="asterix"> * </span></label>
										<div class="col-md-3">
...
$(document).ready(function() {
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("expenseitems/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
