...
@if ( $row->extraservices == 1 )
            ...
            @endif
              					@endif
                        <li class="list-group-item">
                      					 <a href="{{ url('bookesign/update?bookingID='.$id)}}"  onclick="MmbModal(this.href,'{{Lang::get('core.addnewesign')}}'); return false;"  class="btn btn-primary btn-social btn-block "><i class="fa fa-edit"></i> {{Lang::get('core.addesign')}}</a>
                       </li>
                       <li class="list-group-item">
                                <a href="{{ url('booktermsconditions/update?bookingID='.$id)}}"  onclick="MmbModal(this.href,'{{Lang::get('core.addnewtermsconditions')}}'); return false;"  class="btn btn-primary btn-social btn-block "><i class="fa fa-edit"></i> {{Lang::get('core.addtermsconditions')}}</a>
                      </li>
                </ul>
