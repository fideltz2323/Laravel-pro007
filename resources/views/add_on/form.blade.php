...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'addon/save/'.\App\Library\SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'addonFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> {{ Lang::get('core.addon') }}</legend>
				{!! Form::hidden('id', $row['id']) !!}
					  <div class="form-group  " >
						<label for="Add On" class=" control-label col-md-4 text-left"> {{ Lang::get('core.name') }} <span class="asterix"> * </span></label>
						<div class="col-md-3">
					  ...
					  <div class="form-group  " >
						<label for="Cost" class=" control-label col-md-4 text-left"> {{ Lang::get('core.description') }} <span class="asterix"> * </span></label>
						<div class="col-md-6">
						  <input  type='text' name='description' id='description' value='{{ $row['description'] }}' required class='form-control ' />
						 </div>
						 <div class="col-md-2">
						 </div>
					  </div>
...
$(document).ready(function() {
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("addon/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
